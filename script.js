...
const ringTexts = [
  'Galaxy of love From Aylla',//untuk deskripsi planet layer 1
  "Jangan Bad Mood ",//untuk deskripsi planet layer 2
  "Kamu Harus Liat",//untuk deskripsi planet layer 3
  "Liat Ini",//untuk deskripsi planet layer 4
...
function playGalaxyAudio() {
  // Trigger YouTube player yang ada di index.html
  if (window.ytPlayer && typeof window.ytPlayer.playVideo === 'function') {
    window.ytPlayer.playVideo();
  }
  // Sembunyikan tombol musik karena sudah otomatis diputar
